...
const GOOGLE_API_KEY = "AIzaSyAicypcM0a6HI-o1NsaW0dcoQysqcu8kI";
const API_REQUEST_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini.0-flash:generateContent?key=${GOOGLE_API_KEY}`;
